...
function generateYearSelectOptionsHtml(startYear, endYear, defualtYear) {
	let yearRange = '';
...
inputBirthYear.innerHTML = generateYearSelectOptionsHtml(2020, 1920, 1990);



// Declaring function standard way.
// This way of declaring functon allows usage before declaration.
// Javascript automatically moves this kind of declaration to the top of the script.
// This proceure is called hoisting.
dummyFunction();
